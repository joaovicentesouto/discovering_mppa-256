...
for kernel in ucode_1io_to_2c_exec; #ucode_1io_to_2c_exec; ##handler_1io_to_1c_exec; # sync_1io_to_2c_exec sync_2c_to_1io_exec portal_1io_to_2c_exec portal_2c_to_1io_exec; 
do
	echo " "
	echo "  ========== Running Kernel ==========  "
